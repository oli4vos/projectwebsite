...
| Toeslagenscan publieke beta | experimenteel | `visibility: "public"` | aan | `apps/toeslagen-scan` gebruikt de centrale allowances-engine; zorgtoeslag kan voor ondersteunde situaties een officiële 2026-euro-indicatie tonen, terwijl huurtoeslag, kindgebonden budget en kinderopvangtoeslag nog `incomplete`, `special-case` of `unavailable` kunnen teruggeven zolang hun volledige bedraglogica niet genormaliseerd is. Geen PDF/opslag/backend/analytics | 2027-dataset vereist vóór gebruik in 2027 |
