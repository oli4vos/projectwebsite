...
| Toeslagenscan publieke beta | experimenteel | `visibility: "public"` | aan | `apps/toeslagen-scan` gebruikt centrale allowances-engines; zorgtoeslag, huurtoeslag en kindgebonden budget tonen voor ondersteunde 2026-standaardscenario's een euro-indicatie. Kinderopvangtoeslag blijft signal-only zonder totaalbedrag. Geen PDF/opslag/backend/analytics | 2027-dataset vereist vóór gebruik in 2027 |
