...
| Gerichte DUO-leenfase-resultaten | actief | gedeelde `FocusedDuoTool` + centrale studieschuldscenario’s | aan | De start-lenentool kiest de berekeningsmaand met een slider en maandknoppen, toont de centrale normen en markeert een normovergang. Bij een lagere maandnorm blijft bestaande invoer staan en is correctie altijd expliciet. De tool toont thuis- en uitwonende basisbeurs afzonderlijk, linkt naar de centrale aanvullende-beurscalculator en leidt de resterende leenruimte af uit dezelfde centrale 2026-normen. Maandelijkse DUO-bedragen blijven hard begrensd. Een directe scenarioknop rekent maximale hbo/wo-studiefinanciering voor de gekozen duur door zonder diploma en zonder giftomzetting. Opgebouwde schuldsaldi blijven vrije actuele invoer. Bij een verwachte eindschuld staat direct het totale bedrag inclusief rente bij regulier aflossen binnen 35 jaar, zonder extra aflossing of aflosvrije maanden; scherm en PDF gebruiken dezelfde centrale `totalPaid`-uitkomst | n.v.t. |
...
| DUO-impact in maximale-hypotheektool | actief | n.v.t. | aan | De kernuitkomst heeft direct daaronder een ingeklapte berekeningsopbouw met een korte blokken-samenvatting voor toetsinkomen, rente, maandruimte, studieschuldimpact, inkomensgrens en eindmaximum. Wanneer de centrale engine een hogere uitkomst bij een andere officiële toetsrenteband vindt, staan rente en extra leenruimte expliciet in deze samenvatting; onbekende DUO-regelingen worden niet stil met een standaardregeling doorgerekend | n.v.t. |
