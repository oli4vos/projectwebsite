  ...
  amounts: {
    mbo: {
      ...
      parentalContributionTaperPercent: value({
        ...
        verificationStatus: "requires-calculation-guardian-review",
        sourceSection: "PDF-formulierlogica: `* 0.26`",
        explanation: "Officiele PDF-bron; voor publieke implementatie moet de Calculation Guardian de foldertekst en formulierlogica volledig hercontroleren.",
      }),
      parentalStudentDebtDeductionFactor: value({
        ...
        explanation: "Geldt als aftrekpost in ouderbijdrageberekening; niet activeren zonder volledige veldsemantiek.",
      }),
      parentFreeFootSingleParent: value({
        ...
        explanation: "Vrijstelling/bedrag uit interactieve PDF; semantiek per ouder moet voor calculatorimplementatie volledig worden uitgewerkt.",
      }),
    ...
    hboUniversity: {
      ...
      parentalContributionTaperPercent: value({
        ...
        explanation: "Officiele PDF-bron; niet als publieke calculator activeren zonder volledige hercontrole.",
      }),
      parentalStudentDebtDeductionFactor: value({
        regulationId: "duo.additional-grant.parental-student-debt-deduction-factor.2026",
        value: 363,
      ...
      parentFreeFootSingleParent: value({
        ...
        verificationStatus: "requires-calculation-guardian-review",
        sourceSection: "PDF-keuzeveld Situatie ouder: Alleenstaande ouder",
        explanation: "Vrijstelling/bedrag uit interactieve PDF; semantiek moet hercontrole krijgen.",
      }),
      parentFreeFootOtherParentDiedOrIgnored: value({
